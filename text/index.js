...
const typing = (anima) => {
    ...
    const spanArray = util.splitText(target);
...
const neonText = (anima) => {
    ...
    const neonDom = util.cloneElement(target);
...
const backColorCover = (anima) => {
    ...
    const clone = util.cloneElement(target);
...
const converText = (anima) => {
    ...
    const target = document.querySelector(anima.target)
    const spanArray = util.splitText(target);
    const afterText = util.cloneElement(target);
    ...
    const afterTextArray = util.splitText(afterText);
